...
#define RS2                     1.20 /* Stator resistance , ohm*/
#define LS2                     0.00085 /* Stator inductance, H
...
#define NOMINAL_CURRENT2         17806   
#define MOTOR_MAX_SPEED_RPM2     3000   /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT2  6.4   /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG2                -7435   /*!< Demagnetization current */
