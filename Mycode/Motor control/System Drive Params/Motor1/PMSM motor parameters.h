...
#define RS                     1.20 /* Stator resistance , ohm*/
#define LS                     0.00085 /* Stator inductance, H
...
#define NOMINAL_CURRENT         17806   
#define MOTOR_MAX_SPEED_RPM     3000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  6.4
                                 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -7435 /*!< Demagnetization current */
