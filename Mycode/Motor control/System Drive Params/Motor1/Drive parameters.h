...
/* #define HFINJECTION */
// #define ENCODER            当增量编码器连接到位置测量启动位时取消注释*/
//#define HALL_SENSORS        当三个霍尔传感器（60°或120 °放置）用于检测转子速度时取消注释
...
/* State observer constants */
#define CORD_GAIN1                       -11328
#define CORD_GAIN2                       25638
...
#define PID_TORQUE_KD_DEFAULT         200
#define PID_FLUX_KP_DEFAULT           100
#define PID_FLUX_KI_DEFAULT           200
#define PID_FLUX_KD_DEFAULT           200
...
#define FINAL_I_ALIGNMENT               7249 /*!< s16A */
...
#define PHASE2_FINAL_CURRENT           2230
/* Phase 3 */
#define PHASE3_DURATION                1200 /*milliseconds */
#define PHASE3_FINAL_SPEED_RPM         720 /* rpm */
#define PHASE3_FINAL_CURRENT           2602
/* Phase 4 */
#define PHASE4_DURATION                300 /*milliseconds */
#define PHASE4_FINAL_SPEED_RPM         900 /* rpm */
#define PHASE4_FINAL_CURRENT           2602
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_RPM         900 /* rpm */
#define PHASE5_FINAL_CURRENT           2602
...
#define OBS_MINIMUM_SPEED_RPM          0  //580
...
#define  OPEN_LOOP_FOC                 ENABLE//DISABLE   
                                                   /*!< ENABLE for open loop */
...
#define CONSTANT1_Q                    21116
#define CONSTANT1_D                    21116
#define CONSTANT2_QD                   12453
